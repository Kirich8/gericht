            ...
            !function(t, o) {
                ...
                return function() {
                    ...
                    return p.prototype.init = function() {
                        var t = this;
                        this.settings.autoplay && (this.interval = !1, this.fromAuto = !0, this.pausedOnTouchDrag = !1, 
                        this.pausedOnSlideChange = !1, this.settings.autoplayControls && this.controls(), 
                        this.settings.progressBar && this.core.outer.append('<div class="lg-progress-bar"><div class="lg-progress"></div></div>'), 
                        this.settings.slideShowAutoplay && this.core.LGel.once(o + ".autoplay", (function() {
                            t.startAutoPlay();
                            ...
                            t.showProgressBar(), !t.fromAuto && t.interval ? (t.stopAutoPlay(), t.pausedOnSlideChange = !0) : t.pausedOnSlideChange = !1, 
                            t.fromAuto = !1;
                        })), this.core.LGel.on(s + ".autoplay", (function() {
                            t.pausedOnSlideChange && !t.interval && t.settings.forceSlideShowAutoplay && (t.startAutoPlay(), 
                            t.pausedOnSlideChange = !1);
                        ...
                        if (this.settings.progressBar && this.fromAuto) {
                            ...
                            this.interval && (e.removeAttr("style"), o.removeClass("lg-start"), setTimeout((function() {
                                e.css("transition", "width " + (t.core.settings.speed + t.settings.slideShowInterval) + "ms ease 0s"), 
                                o.addClass("lg-start");
                            }), 20));
                        }
                        ...
                        this.core.outer.addClass("lg-show-autoplay"), this.core.outer.find(".lg-progress-bar").addClass("lg-start"), 
                        this.core.LGel.trigger(l, {
                            index: this.core.index
                        }), this.interval = setInterval((function() {
                            t.core.index + 1 < t.core.galleryItems.length ? t.core.index++ : t.core.index = 0, 
                            t.core.LGel.trigger(a, {
                                index: t.core.index
                        ...
                        this.interval && (this.core.LGel.trigger(n, {
                            index: this.core.index
                        }), this.core.outer.find(".lg-progress").removeAttr("style"), this.core.outer.removeClass("lg-show-autoplay"), 
                        this.core.outer.find(".lg-progress-bar").removeClass("lg-start")), clearInterval(this.interval), 
                        this.interval = !1;
                    }, p.prototype.closeGallery = function() {
                        this.stopAutoPlay();
                    }, p.prototype.destroy = function() {
                        this.settings.autoplay && this.core.outer.find(".lg-progress-bar").remove(), this.core.LGel.off(".lg.autoplay"), 
...
PERFORMANCE OF THIS SOFTWARE.
***************************************************************************** */
        var lg_comment_es5_assign = function() {
            lg_comment_es5_assign = Object.assign || function __assign(t) {
                for (var s, i = 1, n = arguments.length; i < n; i++) {
                    s = arguments[i];
                    for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p)) t[p] = s[p];
                }
            ...
            return lg_comment_es5_assign.apply(this, arguments);
        };
        var lg_comment_es5_lGEvents = {
            afterAppendSlide: "lgAfterAppendSlide",
            init: "lgInit",
            hasVideo: "lgHasVideo",
            containerResize: "lgContainerResize",
        ...
        (function() {
            function CommentBox(instance, $LG) {
                this.core = instance;
                this.$LG = $LG;
                this.settings = lg_comment_es5_assign(lg_comment_es5_assign({}, commentSettings), this.core.settings);
                return this;
            }
            CommentBox.prototype.init = function() {
                if (!this.settings.commentBox) return;
                this.setMarkup();
                this.toggleCommentBox();
                if (this.settings.fbComments) this.addFbComments(); else if (this.settings.disqusComments) this.addDisqusComments();
            };
            ...
            CommentBox.prototype.addFbComments = function() {
                var _this_1 = this;
                var _this = this;
                this.core.LGel.on(lg_comment_es5_lGEvents.beforeSlide + ".comment", (function(event) {
                    var html = _this_1.core.galleryItems[event.detail.index].fbHtml;
                    _this_1.core.outer.find(".lg-comment-body").html(html);
                }));
                this.core.LGel.on(lg_comment_es5_lGEvents.afterSlide + ".comment", (function() {
                    try {
                        FB.XFBML.parse();
                    } catch (err) {
            ...
            CommentBox.prototype.addDisqusComments = function() {
                ...
                this.core.LGel.on(lg_comment_es5_lGEvents.beforeSlide + ".comment", (function() {
                    $disqusThread.html("");
                }));
                this.core.LGel.on(lg_comment_es5_lGEvents.afterSlide + ".comment", (function(event) {
            ...
            galleries.forEach((gallery => {
                galleyItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        plugins: [ lg_autoplay_min, lg_thumbnail_min ],
        ...
        window.addEventListener("load", (function(e) {
            datepicker_min("[data-calendar]", {
                formatter: (input, date, instance) => {
                    ...
                    const formatDate = value.replace(/[#.]/g, "/");
            ...
            if (videoModule) {
                ...
                document.addEventListener("watcherCallback", (function(e) {
                    const entry = e.detail.entry;
                    const targetElement = entry.target;
                    if ("video" === targetElement.dataset.watch && targetElement.classList.contains("_init")) if (entry.isIntersecting) targetElement.querySelector("video").muted = false; else targetElement.querySelector("video").muted = true;
                }));
            }
        }));
        window["FLS"] = true;
