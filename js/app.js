(() => {
    ...
    (() => {
        ...
        window.addEventListener("load", (function(e) {
            ...
            if (document.querySelector(".video-module")) document.addEventListener("watcherCallback", (function(e) {
                const entry = e.detail.entry;
                const targetElement = entry.target;
                if ("" === targetElement.dataset.watch) if (entry.isIntersecting) {
                    targetElement.querySelector("video").play();
                    targetElement.querySelector("video").muted = false;
                } else targetElement.querySelector("video").pause();
            }));
        }));
        window["FLS"] = true;
        isWebp();
